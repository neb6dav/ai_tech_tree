...
The public atlas remains at the tagged `v1.0.0` Stable release boundary. PR #13's `v1.2.1 Stable UI release candidate` was squash-merged into `main` by neb6dav as `bf83aad0b8eed6a707fba3f36db3ac179675ead0`; PR head `217d55c055c27641f20aa1dcefae267b9ae9990d` and the squash commit share merged tree `6fb4988f7e746f5793d056e66410bcd794ec0088`, the source branch was deleted, and fast integrity validation passed on that tree in Actions run `33713244320`. Release promotion is authorized pending execution, but neither tag nor deployment has occurred; the full hosted browser/Lighthouse run against the merged tree was skipped and remains pending. Full Windows verification belongs to implementation commit `98d0c4a7bda01cc15303bd0a4939bc0829b98181` and source tree `24649c0d5744df17d97322424662ad0e671a22c5`; intervening differences were documentation, workflow, and test changes only, with application, data, and generated artifacts byte-identical. The public site remains v1.0.0 until deployment succeeds, and the UI approval does not change the citable dataset identity in `CITATION.cff`. Contributions should make uncertainty easier to see, not merely make the graph larger. Pull-request previews and untagged builds are not citable releases; public promotion remains a guarded maintainer action from an approved annotated tag.
