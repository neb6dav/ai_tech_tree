...
assert.match(source, /export const VERSION = '1\.2\.1'/u, 'Network source version must match v1.2.1');
...
assert.match(bundle, /1\.2\.1/u, 'Network bundle version must match v1.2.1');
