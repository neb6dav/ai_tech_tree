...
assert.match(source, /export const VERSION = '1\.2\.1'/u, 'Opportunity source version must match v1.2.1');
...
assert.match(bundle, /1\.2\.1/u, 'Opportunity bundle version must match v1.2.1');
