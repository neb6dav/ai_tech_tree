...
assert.match(source, /export const VERSION = '1\.2\.0'/u, 'Opportunity source version must match v1.2.0');
...
assert.equal(scripts.length, 11, 'Expected eleven inline script elements');
...
assert.match(bundle, /1\.2\.0/u, 'Opportunity bundle version must match v1.2.0');
